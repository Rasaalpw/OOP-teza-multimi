...
int main()
{
    ...
    fout << "}\n";
    D = A * B;
    fout <<"A intersectat cu B = {";
    fout << D<<"}\n";
    E = A-B;
    fout<<"A - B ={";
    fout<<E<<"}\n";
    /*
    cout<<"Introduceti numarul de elemente ale multimii A si elementele acesteia: \n";
    cin >> A;
    cout<<"Introduceti numarul de elemente ale multimii B si elementele acesteia: \n";
    cin >> B;
    system("CLS");
    while (true)
    {
